...
namespace Foam
{
    defineTypeNameAndDebug(fluidFluxFunction, 0);
    defineRunTimeSelectionTable(fluidFluxFunction, dictionary);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::fluidFluxFunction::fluidFluxFunction
(
    const fvMesh& mesh,
...
const Foam::surfaceScalarField& Foam::fluidFluxFunction::phi() const
{
    return phi_;
}

Foam::tmp<Foam::surfaceScalarField>
Foam::fluidFluxFunction::alphaPhi() const
{
    return phi_*alphaf_;
}

Foam::tmp<Foam::volVectorField>
Foam::fluidFluxFunction::gradAlpha() const
{
    return fvc::surfaceIntegrate(mesh_.Sf()*alphaf_);
}

Foam::tmp<Foam::volTensorField> Foam::fluidFluxFunction::gradU() const
{
    return fvc::surfaceIntegrate(mesh_.Sf()*Uf_);
}

Foam::tmp<Foam::volVectorField> Foam::fluidFluxFunction::gradp() const
{
