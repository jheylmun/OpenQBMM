...
{
    defineTypeNameAndDebug(RoePhase, 0);
    addToRunTimeSelectionTable(phaseFluxFunction, RoePhase, dictionary);
}
}
...
Foam::phaseFluxFunctions::RoePhase::RoePhase
(
...
void Foam::phaseFluxFunctions::RoePhase::updateFluxes
(
